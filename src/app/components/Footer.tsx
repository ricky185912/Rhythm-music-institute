        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          >
            ...
            <ul className="space-y-4">
              {['Courses', 'Performances', 'About Us', 'Contact'].map((item) => (
                <li key={item}>
                  <Link
          ...
          >
            ...
            <p className="text-white/40 text-sm mb-4">
              Follow us on social media for updates on performances and new courses.
            </p>
            <div className="flex gap-4">
              <Link href="#" className="text-white/40 hover:text-yellow-400 transition-colors">
                <Facebook size={20} />
              </Link>
              <Link href="https://www.instagram.com/rhythmmusic_institute" target="_blank" className="text-white/40 hover:text-yellow-400 transition-colors">
                <Instagram size={20} />
              </Link>
              <Link href="https://youtube.com/@rhythmmusicinstitutetambar3965" target="_blank" className="text-white/40 hover:text-yellow-400 transition-colors">
                <Youtube size={20} />
              </Link>
            </div>
          </motion.div>
